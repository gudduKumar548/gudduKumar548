...
<a href="https://github.com/gudduKumar548">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=24&duration=3000&pause=800&color=00C9A7&center=true&vCenter=true&width=560&lines=Building+scalable+backend+systems;Currently+Learning+building+%26+applying;Open+to+backend+%26+open-source+collabs" alt="Typing SVG" />
</a>
...
| Project | Description |
|---|---|
| 🎧 **Spotify Backend API** | A backend service replicating core Spotify functionality — auth, playlists & streaming logic |
| 🔗 **URL Shortener API** | A lightweight, high-performance link-shortening service with analytics |
| 🔐 **Authentication System** | A secure, reusable auth module with token-based session management |

</div>

<p align="center">👉 <b><a href="https://github.com/gudduKumar548?tab=repositories">Explore all repositories</a></b></p>
